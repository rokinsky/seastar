...
public:
    using output_type = typename value_decoder_traits<LogicalType::physical_type>::output_type;
...
struct field_reader {
    std::variant<
            ...
            class list_reader,
            class map_reader,
            class typed_primitive_reader<schema::logical_type::BOOLEAN>,
            class typed_primitive_reader<schema::logical_type::INT32>,
            class typed_primitive_reader<schema::logical_type::INT64>,
            class typed_primitive_reader<schema::logical_type::INT96>,
            class typed_primitive_reader<schema::logical_type::FLOAT>,
            class typed_primitive_reader<schema::logical_type::DOUBLE>,
            class typed_primitive_reader<schema::logical_type::BYTE_ARRAY>,
            class typed_primitive_reader<schema::logical_type::FIXED_LEN_BYTE_ARRAY>,
            class typed_primitive_reader<schema::logical_type::STRING>,
            class typed_primitive_reader<schema::logical_type::ENUM>,
            class typed_primitive_reader<schema::logical_type::UUID>,
            class typed_primitive_reader<schema::logical_type::INT8>,
            class typed_primitive_reader<schema::logical_type::INT16>,
            class typed_primitive_reader<schema::logical_type::UINT8>,
            class typed_primitive_reader<schema::logical_type::UINT16>,
            class typed_primitive_reader<schema::logical_type::UINT32>,
            class typed_primitive_reader<schema::logical_type::UINT64>,
            class typed_primitive_reader<schema::logical_type::DECIMAL_INT32>,
            class typed_primitive_reader<schema::logical_type::DECIMAL_INT64>,
            class typed_primitive_reader<schema::logical_type::DECIMAL_BYTE_ARRAY>,
            class typed_primitive_reader<schema::logical_type::DECIMAL_FIXED_LEN_BYTE_ARRAY>,
            class typed_primitive_reader<schema::logical_type::DATE>,
            class typed_primitive_reader<schema::logical_type::TIME_INT32>,
            class typed_primitive_reader<schema::logical_type::TIME_INT64>,
            class typed_primitive_reader<schema::logical_type::TIMESTAMP>,
            class typed_primitive_reader<schema::logical_type::INTERVAL>,
            class typed_primitive_reader<schema::logical_type::JSON>,
            class typed_primitive_reader<schema::logical_type::BSON>,
            class typed_primitive_reader<schema::logical_type::UNKNOWN>
    > _reader;
    ...
    make(const file_reader& file, const schema::node& node_variant, int row_group);
};
